...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("Acta de la asignatura "+asignatura+" del curso "+curso+" de la convocatoria "+convocatoria);
		...
		for(int i=0;i<hijosDeRaiz.getLength();i++) {
			Node nodeItem = hijosDeRaiz.item(i);
		...
		//Obtener notas pero solo de las calificaicones
		    ...
		    for (int j = 0; j < hijos.getLength(); j++) {
		        ...
		        if (hijo.getNodeType() == Node.ELEMENT_NODE) { 
		            ...
		            if (h.getTagName().equals("nota")) {
		                System.out.println("Nota encontrada " + h.getTextContent());
		            }
		        }
		    }
		}
